...
function iniciarJogo(modo: "geral" | "cartoon"): void {
...
function mostrarProximaPergunta(): void {
...
function verificarResposta(escolhida: number): void {
  let pergunta = perguntasAtuais[indicePergunta];
