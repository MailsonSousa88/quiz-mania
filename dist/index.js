...
class Pergunta {
    constructor(texto, alternativas, resposta) {
    ...
    checaRespostaDoJogo() {
        let pergunta = Number(prompt(`${this.textoDaPergunta}\n0. Voltar\n${this.alternativasDaPergunta.join("\n")}`));
...
function temaGeral() {
    ...
    for (let i = 0; i < perguntaTemaGeral.length; i++) {
        let resultadoTemaGeral = perguntaTemaGeral[i].checaRespostaDoJogo();
...
function temaCartoon() {
    let perguntaTemaCartoon = [
    ...
    for (let i = 0; i < perguntaTemaCartoon.length; i++) {
        let resultadoTemaCartoon = perguntaTemaCartoon[i].checaRespostaDoJogo();
...
function menuInicial() {
    let escolhaUmaOpcao = Number(prompt("1. Jogar\n2. Sobre\n3. Placar\n0. Sair"));
...
function jogar() {
    let escolhaUmModo = Number(prompt("1. Tema Geral\n2. Tema Cartoon\n0. Voltar"));
